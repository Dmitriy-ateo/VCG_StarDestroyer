                      ...
                      child: TabBarView(
                        children: [
                          ...
                          Padding(
                            ...
                            child: ListView(
                              children: [
                                if (progression.isSubsystemUnlocked('intensity')) ...[
                                  _buildUpgradeCard(
                                    context: context,
                                ...
                                if (progression.isSubsystemUnlocked('aiming')) ...[
                                  _buildUpgradeCard(
                                    context: context,
                                ...
                                if (progression.isSubsystemUnlocked('chassis')) ...[
                                  _buildUpgradeCard(
                                    context: context,
                          ...
                          Padding(
                            ...
                            child: ListView(
                              children: [
                                // Splitter variants
                                if (progression.isSplitterAngleUnlocked(180.0)) ...[
                                ...
                                if (progression.isSplitterAngleUnlocked(90.0)) ...[
                                  _buildSplitterAngleResearchCard(
                                    context: context,
                                ...
                                if (progression.isSplitterAngleUnlocked(135.0)) ...[
                                  _buildSplitterAngleResearchCard(
                                    context: context,
                                ...
                                if (progression.isSplitterAngleUnlocked(45.0)) ...[
                                  _buildSplitterAngleResearchCard(
                                    context: context,
                                ...
                                // Other devices
                                if (progression.isDeviceRecipeUnlocked(DeviceType.reflector)) ...[
                                ...
                                if (progression.isDeviceRecipeUnlocked(DeviceType.splitter)) ...[
                                  _buildDeviceResearchCard(
                                    context: context,
                                ...
                                if (progression.isDeviceRecipeUnlocked(DeviceType.bomb)) ...[
                                  _buildDeviceResearchCard(
                                    context: context,
                                ...
                                if (progression.isDeviceRecipeUnlocked(DeviceType.gravityWell)) ...[
                                  _buildDeviceResearchCard(
                                    context: context,
                                ...
                                if (progression.isDeviceRecipeUnlocked(DeviceType.portal)) ...[
                                  _buildDeviceResearchCard(
                                    context: context,
